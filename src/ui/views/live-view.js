export function createLiveView({ onCloseRideDashboard, onStartRide, onStopRide, onUpdateRideInput }) {
    const elements = {
        ...
        explorationMiniMapInfo: document.getElementById("explorationMiniMapInfo"),
        explorationMiniMapRoute: document.getElementById("explorationMiniMapRoute"),
        explorationMiniMapPosition: document.getElementById("explorationMiniMapPosition"),
