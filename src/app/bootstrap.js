...
const mainView = createMainView({
    ...
    actions: {
        ...
        route: {
            ...
            listSavedGpxRoutes: routeService.listSavedGpxRoutes,
            loadSavedGpxRoute: routeService.loadSavedGpxRoute,
            continueSavedGpxRoute: routeService.continueSavedGpxRoute,
            deleteSavedGpxRoute: routeService.deleteSavedGpxRoute,
